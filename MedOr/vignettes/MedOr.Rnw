% # NPstat package for R (http://www.R-project.org)
...
This paper present the \verb=MedOr= package for \verb=R= \citep{Rprog}. It is an open source software under \href{http://www.gnu.org/licenses/gpl-3.0.html}{GPLv3}. We illustrate trough examples how to use the functions in the package.
